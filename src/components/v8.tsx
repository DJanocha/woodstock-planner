...
export function V8() {
  ...
  return (
    <div className="bg-background text-foreground">
      <div className="mx-auto grid h-[calc(100vh-theme(spacing.16))] max-w-6xl grid-cols-[100px_1fr] gap-4 overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-4 overflow-auto sm:grid-cols-2 lg:grid-cols-5">
          {[...Array.from({ length: 24 })].map((_, hour) => (
      ...
      <div className="sticky bottom-0 mx-auto mt-8 max-w-6xl bg-background py-4">
