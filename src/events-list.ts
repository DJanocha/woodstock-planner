...
[
  {
    ...
    "kind": "Warsztat",
    "description": "Oczywiście, można nie mieć szczęścia i zamiast nagrody wygrać karę - niespodziankę ;) . Zapraszamy wszystkich śmiałków!",
  ...
  {
    "event": "Wyraź swoje wartości - zaprasza Ministerstwo Sprawiedliwości\nKrajowa Rada Komornicza",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przyjdź i powiedz/pokaż/wymaluj, co jest dla Ciebie ważne i sprawdź, w jaki sposób gwarantuje Ci to Konstytucja. Aktywności organizuje Ministerstwo Sprawiedliwości.",
  ...
  {
    "event": "Kolorowanka XXL – Fundacja Avalon na Festiwalu\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Na stoisku Fundacji Avalon będzie funkcjonowało miejsce dla najmłodszych Festiwalowiczów oraz tych, którzy ciągle czują się młodzi duchem i uwielbiają kolorować! Oprócz dużej kolorowanki, będzie można pokolorować i zabrać na pamiątkę jej mniejsze wersje. Zapraszamy serdecznie!",
  ...
  {
    "event": "Warsztaty dla dzieci \"Ważenie sprawiedliwości – zostań młodym sędzią!\"\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Witamy w Świecie Sprawiedliwości: Na początek poznamy podstawowe zasady prawa i sprawiedliwości , poznamy zawody prawnicze. Będzie można przymierzyć togę i dowiedzieć się czym różnią się zawody prawnicze. Dowiemy się, czym jest Temida i dlaczego trzyma wagę i miecz. Będziemy rysować sprawiedliwość!!!",
  ...
  {
    "event": "Ciało i Umysł\t - zawsze razem\nBody&Mind Edukacja Rozwój Aktywność Marzena Gajlewicz",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Odwiedź nas, znajdziesz tu fascynujące gry, inspirujące warsztaty, ciekawe wykłady i możliwość rozmowy z ekspertami. Odkryj, jak harmonijnie łączyć rozwój ciała i umysłu. Dołącz do nas i zainspiruj się do nowego, zrównoważonego podejścia do życia!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jaki sposób pomagania jest dla Ciebie najlepszy? / Którym (super)bohaterem zwierząt jesteś? / Którym zwierzęciem futerkowym jesteś?",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przyjdź do nas codziennie w godzinach 10:00 - 19:00 i porozmawiajmy. Postaramy się odpowiedzieć na wszystkie nurtujące Was pytania.",
  ...
  {
    "event": "Warsztaty STONE ART - malowanie mandali na kamyczkach\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W Wiosce Beztroskiej możesz stworzyć swój unikatowy, osobisty design mandali na kamyczkach, która będzie wyjątkową pamiątką z Pol and Rock Festival. Warsztaty są organizowane przez Stowarzyszenie MAYE.",
  ...
  {
    "event": "Warsztaty  medytacji z oddechem i dźwiękiem mantr co 30 min\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Może od dawna myślisz, że dobrze byłoby spróbować medytacji, ale nigdy nie masz na to czasu... Jeśli chcesz nauczyć się medytacji - to te warsztaty z pewnością są dla Ciebie! Będzie dużo praktycznych informacji, po co, jak i dlaczego - zwięźle i na temat - szczypta teorii i dużo praktyki! Tylko w Wiosce Beztoskiej!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Macie tak czasem, że jedno dobre słowo w odpowiedniej chwili potrafi przegnać czarne chmury? Wasze dobre słowa, zapisane przez Was na wstążkach, trafią do osób uchodźczych, które odwiedzają biuro Domu Otwartego i pomogą odpędzić troski i zmartwienia.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Codziennie na naszym stanowisku zapraszamy do rozmowy i dyskusji z naszymi ekspertami. Poruszymy tematy na pograniczu nauki, filozofii i science-fiction. Porozmawiamy o tym jakie są szanse znalezienia życia poza Ziemią, jak wygląda praca astrobiologia i kim tak naprawdę jest astrobiolog. Postaramy się pokazać piękno tej międzydziedzinowej dyscypliny naukowej i w razie potrzeby zrobimy wszystko aby rozwiać wszelkie wątpliwości naukowe które mogą zaprzątać głowy festiwalowiczom",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W tym roku gościnnie porad będą udzielać również notariusze i pracownicy Biura Urzędu Ochrony Danych Osobowych",
  ...
  {
    "event": "SYNDICUS AMATEUR LEAGUE E-SPORT CHALLENGER SERIES\nSyndicus Amateur League ( Stanaszek&Drozd Spółki z o.o.",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W trakcie naszego pobytu na Polu ASPowym nasi terapeuci/ psychologowie/ psychodietetycy udzielają 20 minutowych konsultacji. Proponujemy Ci spacer i rozmowę, podczas której otrzymasz indywidualne wskazówki jak, gdzie szukać pomocy. \nDlaczego spacer? Ruch daje swobodę i łatwość w mówieniu o tym, co nie jest łatwe.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Podczas Festiwalu każdy zasługuje również na chwilę relaksu.\nStrefa chillout - odpocznijcie na naszych wygodnych leżakach.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jak może ci pomóc Rzecznik? – Spotkania i rozmowy indywidualne z pracownikami BRPO",
  ...
  {
    "event": "Zacznij dzień z Avalonem! - Zajęcia sportowe prowadzone przez fizjoterapeutów, bazujące na pracy z własnym ciężarem ciała oraz z wykorzystaniem drobnego sprzętu - skierowane do OzN i osób pełnosprawnych\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "Koncepcja duszy i zaświatów w wierzeniach dawnych Słowian\nWioska Słowiańska",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Każda religia posiada koncepcję zaświatów i tego co dzieje się z nami po śmierci. Przybliżenie sfery wierzeniowej dotyczącej składowych pierwiastów duszy, ich pośmiertnych losów, rodzaju zaświatów w oparciu o koncepcję Axis Mundi (związaną z wyobrażeniem drzewa życia) i ich podóży do nich.",
  ...
  {
    "event": "Wielki Quiz Wiedzy!\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Na stoisku Fundacji Avalon przez cały czas trwania Festiwalu będzie funkcjonowało miejsce, w którym uczestnicy Pol’and’Rock Festival mogą sprawdzić swoją wiedzę z zakresu seksualności osób z niepełnosprawnościami i języka inkluzywnego, walczyć ze stereotypami dotyczącymi OzN, jednocześnie dobrze się przy tym bawiąc!",
  ...
  {
    "event": "Pobudź swoją sensorykę! Zajęcia sensoryczne dla każdego\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Serdecznie zapraszamy na wyjątkowe zajęcia sensoryczne na stoisko Fundacji Avalon. To wspaniała okazja zarówno dla dzieci, jak i dorosłych, aby odkrywać i rozwijać swoje zmysły poprzez zabawę i różnorodne aktywności. Te zajęcia nie tylko dostarczą uczestnikom unikalnych doświadczeń, ale będą również inspirującą formą edukacji i rozrywki, łączącą naukę, sztukę i interakcję społeczną. Zajęcia poprowadzą ekspertki w tej dziedzinie. Dołącz do nas i przeżyj niezapomniane chwile pełne zmysłowych odkryć i kreatywnej zabawy!",
  ...
  {
    "event": "Dyskusje na temat hodowli zwierząt na futra\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dyskusje z aktywistami Otwartych Klatek na temat hodowli zwierząt na futra",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Wyjaśniamy czym są i jak działają e-Doręczenia. Jakie są korzyści z posiadania skrzynki do e-Doręczeń, a także pomagamy je założyć.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zrób sobie strajk i noś go na sobie! Mamy szablony więc każda i każdy będzie mógł namalować nasze wzory gdzie tylko chce! Dla bardziej cierpliwych będzie możliwość stworzenia spersonalizowanej i unikatowej biżuterii strajkowej do noszenia nie tylko na festiwalu, ale i na co dzień!",
  ...
  {
    "event": "Odetchnij - świadome oddychanie drogą do zdrowia. Warsztaty pranajamy.\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Odetchnij - to warsztaty pranajamy, czyli świadomego oddychania jogicznego. Ponieważ oddech jest podstawą naszego życia watro jest nauczyć się pracować z oddechem. Przyjdź do Wioski Beztroskiej i naucz się oddychać pełną piersią!",
  ...
  {
    "event": "Beztroskie SPA- techniki medytacji relaksacji i automasażu\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Kto z nas nie odczuwa stresu? Nie pozwól, aby stres kontrolował Ciebie - Ty naucz się kontrolować stres! Skorzystaj z naszego SPA. Poznaj proste techniki relaksacji i automasażu pomogą Ci pozbyć się stresu zarówno na platformie fizycznej, emocjonalnej i mentalnej.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Do czasu eskalacji wojny w Ukrainie z uchodźcami w Polsce było jak z jednorożcami: wszyscy o nich mówili, ale nikt ich nie widział. Jednak Polska przyjmuje uchodźców od dawna, choć nielicznych. \nW naszej wiosce na Was i Wasze pytania czekają codziennie osoby, które pomagają uchodźcom oswoić sobie Polskę. Niektóre z nich same mają doświadczenie migracji.\nPrzyjdźcie, porozmawiajmy!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "U nas możesz się dowiedzieć kim jest hacker i czy Ty też możesz nim być. Poznasz koncepcję Hackerspace i porozmawiasz z hackerami tworzącymi takie miejsca w różnych miastach. A może sam potem założysz Hackerspace w swoim mieście...\nPostaramy się również odpowiedzieć na wszelkie związane z tym tematem pytania.\nZapraszamy zarówno dzieci jak i dorosłych.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy wszystkie dzieci - te młodsze i te starsze na nasze stanowisko plastyczne. Zapewnimy Wam dużo kolorów i uśmiechu.",
  ...
  {
    "event": "Punkt Konsultacyjny ds. Uzależnień na Pol’and’Rock Festival 2024\nGórnośląskie Stowarzyszenie \"Familia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Punkt Konsultacyjny ds. Uzależnień na Pol’and’Rock Festival 2024, w ramach którego oferujemy konsultacje, działania informacyjno – edukacyjne oraz działania interwencyjne związane z problematyką uzależnień.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Firma Viessmann nie tylko dostarcza kompletne i ekologiczne systemy dla domów, ale również aktywnie walczy ze smogiem. Stop SMOG Car Viessmann to specjalny samochód wyposażony w powietrzną pompę ciepła, nowoczesny kocioł gazowy, panele fotowoltaiczne i oczyszczacz powietrza. Zapraszamy Uczestników po dawkę wiedzy z zakresu energetyki!",
  ...
  {
    "event": "Wschodnie sposoby na długowieczność -  warsztaty akupresury\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Kiedy mądrość Wschodu puka do drzwi Zachodu, żeby przekazać nam jak w prosty sposób, możemy sami stosować techniki medycyny chińskiej i akupresury, aby nasze utrzymać ciało w zdrowiu i harmonii. Zapraszamy do Wioski Beztroskiej!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zajęcia ceramiczne poprowadzi ekipa z ośrodka Monar w Milejowicach.\nWpadnij i ulep co ci w duszy gra :)",
  ...
  {
    "event": "Joga – przepis na zachowanie balansu i energii przez cały dzień\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Joga – przepis na zachowanie balansu i energii przez cały dzień",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dobrego popołudnia :) Od 16.00: - strefa chilloutu z możliwością zagrania z proste gry towarzyskie, jak np. mega Jenga; - dobrego popołudnia: prezentacja „Bajek, które nie istniały”, niezwykłej książki wydanej przez Klimas Wkręt-met, a stworzonej i zilustrowanej przez dzieci.",
  ...
  {
    "event": "Warsztaty: Zabawa, Kreatywność i Rozwój!\nBody&Mind Edukacja Rozwój Aktywność Marzena Gajlewicz",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "- mobilna wystawa nt 100.lecie praw człowieka (roll-upy),\n- Memy Marty Frej nt praw kobiet\n- memy nt definicji zgwałcenia",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztaty haftu tradycyjnego oferują uczestnikom naukę podstawowych technik haftu przekazywanych z pokolenia na pokolenie. Uczestnicy będą mogli praktycznie zastosować zdobyte umiejętności, tworząc własne haftowane dzieła.",
  ...
  {
    "event": "Wymyślaj, nie maluj! Twórz obrazy z sztuczną inteligencją!\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztaty dla dzieci prowadzone przez radców prawnych w oparciu o technologię AI",
  ...
  {
    "event": "Odetchnij - świadome oddychanie drogą do zdrowia.\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Odetchnij - to warsztaty pranajamy, czyli świadomego oddychania jogicznego. Ponieważ oddech jest podstawą naszego życia watro jest nauczyć się pracować z oddechem. Przyjdź do Wioski Beztroskiej i naucz się oddychać pełną piersią!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Chilloutowe relaksacje z lawendą i ogórkiem - czyli festiwalowe SPA i strefa pełnego relaksu. Zapraszamy do Wioski Beztorskiej!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Popularna gra \"Memory\" oparta o symbolikę prawniczą. Zabawa z nagrodami rzeczowymi",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przyjdź i pomaluj swoje ciało! Body Art Painting to wyjątkowe warsztaty na których możesz sam sobie zrobić oryginalny \"makijaż\" całego ciała. Zapraszamy do Wioski Beztroskiej do namiotu ART!",
  ...
  {
    "event": "Techniki medytacji relaksacji i automasażu - warsztaty praktyczne\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Kto z nas nie odczuwa stresu? Nie pozwól, aby stres kontrolował Ciebie - Ty naucz się kontrolować stres! Proste techniki relaksacji i automasażu pomogą Ci pozbyć się stresu zarówno na platformie fizycznej, emocjonalnej i mentalnej.",
  ...
  {
    "event": "Strefa “Tatuaże Zamiast Futra” - zrób sobie zmywalny tatuaż\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "FAKTY, MITY i JĘZYK OPOWIEŚCI O UCHODŹCACHmity i język opowieści o uchodźcach\nStowarzyszenie Amnesty International",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy do namiotu Amnesty International na warsztat o tym, jak o osobach uchodźczych mówić językiem niedyskryminującym i inkluzywnym, a także jak weryfikować fakty i mity o osobach w drodze.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Autorski tor przeszkód, test na wytrwałość, który uczy przekraczania własnych granic w stosowaniu się do selektywnej zbiórki puszek aluminiowych, a każda z przeszkód odnosi się do jednego z 9 etapów cyrkularnego życia puszki aluminiowej.",
  ...
  {
    "event": "Strefa Komfortu\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W Strefie Komfortu Fundacji Avalon, każdy, kto tego potrzebuje, będzie mógł znaleźć odrobinę wytchnienia od festiwalowych dźwięków i emocji. Strefa tworzona jest z myślą o osobach z niepełnosprawnościami, które szukać będą chwili odpoczynku od zgiełku wartkiego, festiwalowego życia.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Podczas prezentacji skupimy się na wyjaśnieniu pojęcia podpisu elektronicznego. W prosty sposób przedstawimy i omówimy zasadę działania i jego główne komponenty.",
  ...
  {
    "event": "Quiz \"Równość Praw - poznaj swoje prawa i obowiązki\"\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "quiz prawniczy z nagrodami w trakcie którego możesz sprawdzić swoją wiedzę z praw człowieka i obywała w zakresie równości wobec prawa,  niedyskryminacji, historii praw człowieka w tym zakresie, przyjdź wylosuj pranie, odpowiedz , a potem w loterii wygraj nagodę",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Czyli co każdy może nauczyć się, rozwinie dzięki Toastmasters, kto jest lub chce być liderem(-ką), przywódcą(-czynią), kierownikiem(-czką), matką, ojcem, przyjacielem(-ką). I co daje dodatkowo bycie wśród pozytywnie zakręconych ludzi.",
  ...
  {
    "event": "Notariusz w ramonesce. O ślubie humanistycznym\nIzba Notarialna w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W temacie: ślub humanistyczny, notariusz a związki partnerskie, o pełnomocnictwie i testamencie. Wystąpienie i odpowiedzi na pytania.",
  ...
  {
    "event": "Aktywności: Escape tele-room, Gry i Zabawy, Quizy z nagrodami\nCisco Systems Sp. z o.o.",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W ciągu dnia przyjdź na nasze stoisko, gdzie będziemy organizować gry, zabawy, quizy i escape room.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W mobilnym gabinecie nasz personel medyczny będzie wykonywał przesiewowe badanie wzroku, które jest bezinwazyjne i wykrywa podstawowe wady wzorku, spirometrię, czyli badanie układu oddechowego oraz przeprowadzona zostanie analiza składu ciała. Do każdego badania uczestnik otrzyma wynik papierowy oraz zostanie on omówiony z naszym wykwalifikowanym personelem. Z badań skorzystać będzie można w godzinach od 12:00 do 18:00.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Nasz personel przy stoisku będzie wykonywał testy z krwi na poziom cukru oraz dla mężczyzn PSA, który wykrywa podwyższony antygen prostaty. Dodatkowo przy stoisku będzie wykonywane ciśnienie  dla wszystkich chętnych osób. Badania te jak i wszystkie inne będą dostępne dla uczestników  w godzinach od 12:00 do 18:00.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat ma ułatwić zauważenie  osoby w kryzysie w naszym otoczeniu. W pracy, w szkole, na uczelni i co z tym zrobić. Czy i  jak z nią rozmawiać, co jej proponować. Czy jest się czego bać?",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Może od dawna myślisz, że dobrze byłoby spróbować medytacji, ale nigdy nie masz na to czasu... Jeśli chcesz nauczyć się medytacji - to te warsztaty z pewnością są dla Ciebie! Będzie dużo praktycznych informacji, po co, jak i dlaczego - zwięźle i na temat - szczypta teorii i dużo praktyki!",
  ...
  {
    "event": "Sztuczna Inteligencja - Super.... Bohater czy Złoczyńca\nCisco Systems Sp. z o.o.",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Czy sztuczna inteligencja uratuje świat, czy może go zniszczy? Czy AI jest naszym sprzymierzeńcem, czy raczej potencjalnym wrogiem? Ta prezentacja ukazuje innowacyjne zastosowania AI oraz ciemne strony tej technologii.  Dołącz do nas, aby wspólnie odkryć przyszłość pełną możliwości i wyzwań!",
  ...
  {
    "event": "Warsztaty Wyplatania Łapaczy Snów “Goń marzenia, łap sny”\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy do Wioski Beztroskiej, gdzie zrobisz swój własny ekologiczny łapacz snów! To wyjątkowa i osobista pamiątka z festiwalu!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przyjdź, zobacz i daj się zaskoczyć! Interaktywne pokazy jazdy na mobilerach – trójkołowych rowerach bez pedałów, które zmieniają świat sportu dla osób z niepełnosprawnością. Dołącz do naszych mistrzów, poznaj tajniki ich technik jazdy i sam przetestuj ten niesamowity sprzęt.",
  ...
  {
    "event": "Stereotypy karmiące przemoc i jak im przeciwdziałać\nFundacja Feminoteka",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jakie słowa i zachowania wspierają i utrwalają przemoc? Co możemy zrobić, aby nie wzmacniać toksycznych zachowań? Czy nasze komunikaty należą do pozytywnych czy wręcz przeciwnie, choć chcemy dobrze?",
  ...
  {
    "event": "Analiza osobowościowa. Odkryj swoją wewnętrzną siłę - warsztaty\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Każdy z nas ma mocniejsze i słabsze strony. Ponieważ nasze osobowością są rożne - nasze moce są rownież różne. Warto je odkryć! Na tych warsztatach dowiesz się jak odkryć swoją indywidualną, wewnętrzną moc! Zapraszamy do Wioski Beztroskiej!",
  ...
  {
    "event": "Gdzie uciekają Twoje pieniądze? Warsztaty z zarządzania i planowania budżetu domowego przy uwzględnieniu budowania zaplecza finansowego.\nCelina Wojciechowska Finanse i Ubezpieczenia",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Ludzki mózg to genialny instrument pozwalający na odbieranie, przetwarzanie i generowanie bodźców. Mózg działa podobnie jak mięśnie i ciało. Jeśli systematycznie pobudzamy go do wysiłku, pracuje sprawnie i cieszy się dobrą kondycją również w okresie późnej dorosłości. Warsztaty koncentrować się będą na treningu funkcji poznawczych, które w największym stopniu ulegają osłabieniu z wiekiem – czyli uwadze, koncentracji, zapamiętywaniu oraz funkcjach językowych. Podczas warsztatów zaprezentowane zostaną proste ćwiczenia pamięciowe oraz stymulujące obie półkule mózgu, które można wykonywać z dziadkami wspierając ich sprawność.",
  ...
  {
    "event": "Kocie Inspiracje Zawodowe\nBody&Mind Edukacja Rozwój Aktywność Marzena Gajlewicz",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "KIEDY TO SIĘ STAŁO? PRZEKROCZENIE MAGICZNEJ GRANICY\nFundacja Biuro Służby Krajowej Anonimowych Alkoholików w Polsce",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat pt. \"Kiedy to się stało? Przekroczenie magicznej granicy\"- będzie dotyczył uchwycenia momentu, w którym człowiek zaczyna identyfikować się jako alkoholik. Każdy z członków wspólnoty zadał sobie kiedyś tytułowe pytanie. Jako, że AA nie zajmuje się diagnozowaniem, podjęliśmy ten temat, aby powstała przestrzeń do dzielenia się własnymi doświadczeniami, które być może udzielą odpowiedzi osobom zainteresowanym.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Stworzymy prawdziwe miejsce rozgrywek gier planszowych, które wciągną w swój świat z pewnością nie jednego miłośnika planszówek. Posiadamy prawdziwe hity gier fabularnych, familijnych, przygodowych a także gry w wersji plenerowej - XXL dla dzieci. To wszystko oczywiście pod okiem czujnych instruktorów gier.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jak stworzyć dobre CV? Na co zwracają uwagę rekruterzy? Podczas naszej sesji dostaniesz pakiet praktycznych wskazówek, które pomogą Ci w znalezieniu wymarzonej pracy.",
  ...
  {
    "event": "Dyżur  terapeutki TSR (Terapia Skoncentrowana na rozwiązaniach)\nOgólnopolski Strajk Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przedmiotem TSR, jej zainteresowanie nie  przeszłością, a raczej teraźniejszością i przyszłością. O tyle zajmuje się historią życia osoby w potrzebie , o ile można z niej odczytać mocne strony osoby, cenne doświadczenia i sposoby radzenia sobie z wcześniejszymi kryzysami.",
  ...
  {
    "event": "Futbol Amerykański na Pełnym Kontakcie: Tacklowanie z Warsaw Sirens\nStowarzyszenie Kobiecej Drużyny Futbolu Amerykańskiego - Klub Sportowy Warsaw Sirens",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Chcesz poczuć prawdziwą siłę futbolu amerykańskiego? Na tych warsztatach odkryjesz jak bezpiecznie i skutecznie wykonać twz. “tackle”. Z pomocą specjalnego wałka do tacklowania, pokażemy Ci techniki, które pomogą Ci zdominować boisko. Przyjdź i odkryj swoją siłę!",
  ...
  {
    "event": "Warsztaty Twórczości: Malowanie Swoich Potrzeb\nBody&Mind Edukacja Rozwój Aktywność Marzena Gajlewicz",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dołącz do naszych warsztatów, aby wizualnie wyrazić swoje emocje i potrzeby, tworząc unikalne dzieła na chuście za pomocą farb akrylowych i medium. Możesz korzystać z przygotowanych szablonów lub malować według własnych pomysłów. Warsztaty odbywają się w przyjaznej, luźnej formie, co pozwala na swobodną twórczość w określonym czasie, a swoje prace możesz zabrać do domu i praktycznie wykorzystać. Zapewniamy wszystkie materiały oraz wsparcie prowadzących. Zajęcia łączą swobodę twórczą z elementami arteterapii, umożliwiając głębokie doświadczenie barw i emocji w inspirującej atmosferze.",
  ...
  {
    "event": "Naucz się w protesty  + \"Jeden/jedna z dziesięciu\" Konkurs wiedzy o historii Ogólnopolskiego Strajku  Kobiet oraz o prawach obywatelskich.\nOgólnopolski Strajk Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Rozmowa o rodzajach zgromadzeń publicznych i czynnościach, które należy wykonać, aby zorganizować legalnie zgromadzenie publiczne. Jak poradzić sobie w przypadkach sytuacji drażliwych na wydarzeniach ulicznych. Po dyskusji wprowadzenie do gry konkursu \"Jeden/jedna z dziesięciu\"- Jest to konkurs wiedzy o historii Ogólnopolskiego Strajku Kobiet oraz o prawach obywatelskich i zgromadzeniach. Nagrodą są wyjątkowe gadżety od My Voice My Choice ❣️",
  ...
  {
    "event": "Warsztaty zaplecione w wianki - upleć sobie wianek!\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Niektórzy z natury plotą trzy po trzy, my zaś z natury pleciemy wianki. Szumiące trawy, polne kwiaty czy dziko rosnące zioła przerabiamy na kolorowe sploty i mamy  przy tym dziki ubaw. Chcesz być na czasie? Samoobsługowa produkcja wianków codziennie.",
  ...
  {
    "event": "Zarządzanie stresem i emocjami. Spotkanie z terapeutą i trenerem mentalnym Magdą Cieślą\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na głęboki relaks w Wiosce Beztroskiej! Techniki relaksacyjne - Joga Nidra pomogą Ci rozluźnić całe ciało i uspokoić umysł. To niezapomniane doświadczenie prowadzonej przez instruktora relaksacji pomoże Ci odpocząć i zregenerować się przed kolejnymi festiwalowymi atrakcjami!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W interakcji z gośćmi zgromadzonymi w namiocie będziemy popularyzować wiedzę o prawie karnym, cywilnym i administracyjnym. Quiz przeprowadzony zostanie przez adwokatkę o prokuratorkę w formie zadania pytań. Za trafne odpowiedzi przewidziane są drobne upominki.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W interakcji z gośćmi zgromadzonymi w namiocie będziemy popularyzować wiedzę o prawie karnym, cywilnym i administracyjnym. Quiz przeprowadzony zostanie przez adwokatkę i prokuratorkę w formie zadawania pytań. Za trafne odpowiedzi przewidziane są drobne upominki.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat przeciwdziałający dyskryminacji osób chorujących psychicznie. Szkolenie skierowane jest do wszystkich, którzy mogą mieć kontakt z osobami po kryzysie psychicznym.",
  ...
  {
    "event": "PRAWO I ŻYCIE NA UCHODŹCTWIE W POLSCE\nStowarzyszenie Amnesty International",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy do namiotu Amnesty na rozmowę z ekspertką na temat prawnej i społecznej sytuacji osób żyjących na uchodźctwie w Polsce.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Medytacja Wybaczania pomaga oczyścić nasze serce z negatywnych emocji, żalu, złości i nienawiści. Pomaga wybaczyć, cokolwiek leży nam na \"wątrobie\", uwolnić się od tego i poczuć się lepiej! Zapraszamy do Wioski Beztroskiej na to wyjątkowe doświadczenie uwolnienia naszego serca.",
  ...
  {
    "event": "Weź udział w spocie/sesji do kampanii #CzasNaZakaz\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Napisz z nami dobre zakończenie - weź udział w spocie/sesji do kampanii, którą opublikujemy jesienią #CzasNaZakaz",
  ...
  {
    "event": "Prezentacja-Zdalna Harmonia: Praca, Życie i Technologia\nCisco Systems Sp. z o.o.",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na slackline - tu możesz poprawić swoją równowagę i wzmocnić mięśnie! Spróbuj swoich sił na linie, napinanej na niewielkiej wysokości. Nie ma lepszego sposobu na poprawę koordynacji i koncentracji niż trening na slack'u!",
  ...
  {
    "event": "Face Fitness naturalne rytuały dla pięknej twarzy\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jeśli chcesz zachować swoje piękno jak najdłużej, skorzystaj z okazji aby nauczyć się ćwiczeń Face Fitness! Naturalne rytuały dla pięknej twarzy pomogą Ci  zachować naturalne piękno i zdrowy wygląd!",
  ...
  {
    "event": "„Twoje prawa, nasza sprawa” – prawa człowieka\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "„Twoje prawa, nasza sprawa” – prawa człowieka. Zajęcia prowadzone na bazie wydanej przez BRPO publikacji i na podstawie spraw, jakie są zgłaszane do Rzecznika Praw Obywatelskich. Warsztat wiedzy obywatelskiej i wszelkich działań na rzecz praw człowieka",
  ...
  {
    "event": "Tor przeszkód - Niewidzialny Świat\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dźwięk ma niezwykłą siłę i może dać nam wewnętrzny komfort i poczucie bezpieczeństwa, a nawet mieć działanie lecznicze. Zapraszamy do Wioski Beztroskiej na wyjątkowe zajęcia Sound Healing, czyli warsztaty terapii dźwiękiem.",
  ...
  },
  {
    ...
    "place": "Strefa Działań Twórczych ASP",
    "kind": "Warsztat",
    "description": "Gimnastyka Mózgu to zajęcia ruchowe mające na celu koordynację półkul mózgowych i ogólną poprawę działania mózgu. Na tych warsztatach nauczysz się prostych ćwiczeń, które spokojnie możesz stosować w domu i w ten sposób codziennie trenować swój mózg!",
  ...
  {
    "event": "Warsztaty dla par budowania relacji – Mosty, mury, a może coś jeszcze\nToastmasters",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na wyjątkowe zajęcia, które łączą wykłady, dyskusje i zabawę. Naszym celem jest dostarczenie uczestnikom narzędzi do świadomej pracy nad sobą. Poznasz techniki neurogimnastyki, które wspierają samodoskonalenie i rozwijanie wewnątrzsterowności.\nZainspiruj się, zdobywając nowe umiejętności i rozwijając świadome podejście do swojego życia. Dołącz do nas i odkryj, jak skutecznie pracować nad sobą!",
  ...
  {
    "event": "Warsztaty Stone Art - malowanie osobistej mandali na kamyczkach\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W Wiosce Beztroskiej możesz stworzyć swój unikatowy, osobisty design mandali na kamyczkach, która będzie wyjątkową pamiątką z Pol and Rock Festival. Warsztaty są organizowane przez Stowarzyszenie MAYE.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Intuicyjny taniec zawierający w sobie pozycja i ruchy zaczerpnięte z Hatha jogi, jest to też taniec spontaniczny i bardzo osobisty. Warto spróbować, wyrazić emocje, a jednocześnie odprężyć się i oddać swoje ciało muzyce i tańcowi!",
  ...
  {
    "event": "“Bycie (w ruchu) bez presji”\nProjekt The Presja- Fundacja Z Wyboru",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat ma na celu zbudowanie Twojej świadomości w zakresie gestu, ruchu, przestrzeni, dynamiki ciała, interakcji. Zaproszę Cię do odkrycia jaki jest Twój ruch regeneracyjny, energia z ciała czy powody do nadawania ruchu. Jak się do tego przygotować? Po prostu przyjdź i zaciekaw się...\n\nadresaci: dorośli\nprowadząca: Martyna Nowak - psycholożka",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Chcesz sprawdzić swoją znajomość piosenek z lat 60., 70. i 80.? Zapraszamy na wyzwanie \"Jaka to melodia?\" gdzie drużyny będą rywalizować ze sobą zgadując tytuły i autorów kultowych piosenek z pokolenia naszych rodziców i dziadków. Przyjdź samemu lub weź ze sobą znajomych, a dobra zabawa jest gwarantowana!",
  ...
  {
    "event": "Rozmowy o zachodzie słońca : \"Pan i Pani swoich praw”\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Poznasz różne perspektywy dotyczące równouprawnienia w pracy, edukacji, rodzinie i życiu społecznym. Usłyszysz historie i doświadczenia osób, które na co dzień mierzą się z wyzwaniami i korzyściami równouprawnienia. Wymienimy się pomysłami na to, jak możemy wspólnie budować bardziej sprawiedliwe i równe społeczeństwo. Zaproszeni eksperci oraz uczestnicy dyskusji podzielą się swoimi poglądami i wiedzą, tworząc przestrzeń do inspirującej wymiany myśli. Dołącz do nas i odkryj, jak być \"Panem i Panią swoich praw\" w dzisiejszym świecie!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Spotkanie na koniec dnia dla najmłodszych z książeczką na dobranoc o tematyce wyciszającej, relaksacyjnej i dobrym, spokojnym śnie. \nDziałanie ma na celu promocję literatury dziecięcej.",
  ...
  {
    "event": "ROZMOWY W TOKU\nFundacja Biuro Służby Krajowej Anonimowych Alkoholików w Polsce",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W naszym namiocie będzie stała skrzyneczka do której możecie wrzucać pytania i interesujące Was tematy dotyczące trzeźwienia i AA.  Rozmowy w tłoku - przestrzeń na luźne rozmowy i próbę odpowiedzi na Wasze zagadnienia.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Tańce integracyjne – Nauka tańców opracowanych na podstawie figur i motywów tanecznych różnych narodów",
  ...
  {
    "event": "Mantra Time klimatyczna przestrzeń wypełniona dźwiękami jogi.\nStowarzyszenie MAYE",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Mantra Time klimatyczna przestrzeń wypełniona dźwiękami jogi. Zapraszamy Cię do Wioski Beztroskiej, do klimatycznej przestrzeni, gdzie możesz śpiewać, tańczyć, grać na instrumentach lub po prostu zanurzyć się w dźwiękach mantr i cieszyć się tą magiczną chwilą.",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Wydawanie kart EKUZ, konsultacje dot. profilaktyki zdrowia\nNFZ",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA SPORTU -  Gry plenerowe dla dużych i małych\nDecathlon",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA NORTH&ROCK - warsztaty „naprawiaj nie wyrzucaj”, dmuchaniec dla najmłodszych\nNorth.pl",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  },
  {
    ...
    "place": "Duży Namiot ASP",
    "kind": "Spotkanie",
    "description": "Aga i Bartek Wrzosek – duet podróżników, kórzy porzucili swoje dotychczasowe życie, aby wyruszyć w podróż życia 50-letnim busem, Volkswagenem T2 z 1972 roku. Przez 10 miesięcy przemierzali Amerykę Północną, od Wielkich Jezior Kanady po kalifornijskie pustynie. Spotkanie z nimi otworzy tegoroczne spotkania ASP.  \n \n  #ASP",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Co Ci leży na wątrobie? - badania profilaktyczne\nInvestmed",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Płuca po pandemii – badania profilaktyczne\nSzGiCHP Koszalin",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA KONSTELACJA NAUKI - Wyścigi pojazdów solarnych, warsztaty, animacje z wykorzystaniem VR, kosmiczne roboty\nZachodniopomorski Uniwersytet Technologiczny",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA POZNAJ POMORZE ZACHODNIE - Informacja turystyczna i spotkania z historią",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA SPORTU -  Piłkarski tor przeszkód\nPogoń Football School",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty malowania festiwalowych flag\nMBP Borne Sulinowo",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Otyłość olbrzymia, czyli jak schudłam z NFZ 60 kilogramów - krok po kroku. Ty też to możesz zrobić.\nToastmasters",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Otyłość olbrzymia, czyli jak schudłam z NFZ 60 kilogramów - krok po kroku. Ty też to możesz zrobić.",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Męskie zdrowie – badania profilaktyczne\nFizjosport",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "Warsztaty Malowania i Zdobienia Koszulek oraz Eco Toreb na Pol'and'Rock 2024\nGmina Czaplinek",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - analiza składu masy ciała, pomiar ciśnienia tętniczego krwi, warsztaty z narko- i alkogoglami\n(GIS WSSE)",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA KONSTELACJA NAUKI - Kamera szybkoklatkowa, robopies, energia słońca i wiatru\nPolitechnika Koszalińska",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "Pokaz Szkolenia VR dla młodych sedziów\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Pokaz szkolenia VR dla młodych sędziów,  Gogle VR przeniosą Cię na prawdziwą salę rozpraw i wcielisz się w rolę sędziego decydującego o losie trudnego świadka .Immersyjny świat szkolenia zapewni wrażenia prawdziwej sali rozpraw.",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Sprawdź swoją tarczycę – badania profilaktyczne\nSPWSZ Arkońska",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA KONSTELACJA NAUKI - animacje, warsztaty, spektrometr do oglądania widm\nUniwersytet Szczeciński",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA WIEDZY -  Profilaktyka raka piersi - dlaczego dotyka coraz młodsze kobiety?\nZCO",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Inne",
    "kind": "Inne",
    "description": "Chcesz dorzucić swoją cegiełkę do wystroju Dużej Sceny? Przybij do niej swoją flagę!Zapraszamy 10:30 do wejścia od strony Strefy Allegro.",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Nowy sektor nowe możliwości – innowacyjne miejsca pracy w morskiej energetyce wiatrowej\nPSEW",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Kryminalna Gra Terenowa \"W Matni\"\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztaty antydyskryminacyjne prowadzone przez członkinie SKK i zaproszonych gości",
  ...
  {
    "event": "Postaramy się przybliżyć najważniejsze kwestie regulujące prawo o zgromadzeniach.\nIzba Adwokacka w Warszawie",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W trakcie warsztatu słuchacze dowiedzą się co oznacza wolność zgromadzeń, dlaczego wolność zgromadzeń jest taka ważna, jak wolna jest wolność zgromadzeń czy nastolatek ma prawo wziąć udział w zgromadzeniu publicznym, czy blokowanie pokojowych zgromadzeń przez Policję jest zgodne z podstawowymi prawami i wolnościami w państwie demokratycznym.",
  ...
  {
    "event": "„Twoje prawa, nasza sprawa” – prawa osób z niepełnosprawnościami\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "„Twoje prawa, nasza sprawa” – prawa osób z niepełnosprawnościami. Zajęcia prowadzone na bazie wydanej przez BRPO publikacji i na przykładach spraw, jakie są zgłaszane do Rzecznika Praw Obywatelskich. Warsztat wiedzy obywatelskiej i wszelkich działań na rzecz praw człowieka",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przyjdź, ozdób, i unieś się z nami! Stwórz swoje unikalne skrzydła pełne mocy, które będą Twoim towarzyszem przez cały festiwal. Dziel się radością i dodawaj skrzydeł innym uczestnikom!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat o przemocy w związkach. O tym, jakie mechanizmy rządzą w takich przypadkach i dlaczego osoby doświadczające przemocy tkwią w toksycznej relacji oraz jak im pomóc się z niej uwolnić.",
  ...
  {
    "event": "Kto mi poda szklankę wody? Warsztaty z pisania testamentów.\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Notariusze przeprowadzą warsztat jak napisać testament oraz opowiedzą na pytania związane z testamentami, w tym ile trzeba mieć lat, żeby napisać testament itp.",
  ...
  {
    "event": "Wszystko co chcesz wiedzieć o działaniu Otwartych Klatek, ale boisz się zapytać\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "\"Wszystko co chcesz wiedzieć o działaniu Otwartych Klatek, ale boisz się zapytać\" - sesja Q&A z zespołem Otwartych Klatek",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Podczas warsztatów nauczymy się czym jest język inkluzywny, jego przykłady oraz jak się nim posługiwać w życiu codziennym. Porozmawiamy także o stereotypach związanych z różnymi grupami społecznymi oraz jak tworzyć i używać feminatywów.",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Warsztat pierwszej pomocy, udary, oparzenia, reakcje alergiczne\nWSPR",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Ścieżki kariery – spotkanie z technikiem turbin wiatrowych\nPSEW",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zajęcia skierowane do młodzieży licealnej i studentów, przybliżające drogę do zawodu komornika.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Wspólne, pod kierunkiem artystki Mai Baranowskiej- Karwackiej rysowanie komiksu o zdrowiu Psychicznym.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zagrajmy w grę! Zobaczymy ile wiesz na temat polskiego systemu wymiaru sprawiedliwości. Obawiasz się, że może być trudno? Spokojnie! Pomożemy w realizacji zadań i dotarciu do finału. Z całą pewnością będzie zabawnie! Zamiast leżeć w namiocie zagraj z nami - to doskonała metoda na rozruch przed koncertami.",
  ...
  },
  {
    ...
    "place": "Strefa Działań Twórczych ASP",
    "kind": "Warsztat",
    "description": "Każdy z nas ma mocniejsze i słabsze strony. Ponieważ nasze osobowością są tak różne - nasze moce są rownież różne. Warto je odkryć! Na tych warsztatach dowiesz się jak odkryć swoją indywidualną, wewnętrzną moc!",
  ...
  {
    "event": "TAKE THIS JOB AND SHOVE IT! - czyli jak uczciwie wiążę koniec z końcem\nFundacja Biuro Służby Krajowej Anonimowych Alkoholików w Polsce",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat pt. \"Take this job and shove it! - czyli jak uczciwie wiążę koniec z końcem\" -spotkanie obejmie tematykę szeroko rozumianej kariery zawodowej. Choroba alkoholowa niekiedy łączy się z nieuczciwymi sposobami zarabiania pieniędzy, długami, nieumiejętnością radzenia sobie w sytuacjach zawodowych lub idzie w parze z pracoholizmem. Dlatego chcemy podjąć ten ważny wątek.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dzisiaj praktycznie każdy z nas trzyma w kieszeni całkiem niezły aparat fotograficzny, ale często jesteśmy niezadowoleni ze swoich zdjęć z wakacji czy polandrockowego koncertu. Co zrobić, żeby były lepsze? Pokażemy Wam kilka prostych zasad i tricków, które kompletnie odmienią Wasze utrwalane wspomnienia.",
  ...
  {
    "event": "Legendarny quiz z prawa karnego z nagrodami\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "najpierw wylosujesz pytanie z prawa karnego, potem odpowiesz i wylosujesz skrytą w naszej loterii nagrodę niespodziankę , chodzi o to ze sprawdzić swoją wiedzę z prawa karnego!",
  ...
  {
    "event": "Warsztaty dla par budowania relacji –Zróbmy sobie masarz\nToastmasters",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przynieście ręcznik, karimatę i jakieś smarowidło (olejek, krem, balsam) do masażu. Poznasz drobiazgi, które wzbogacą Waszą relację, a przy okazji dowiesz się trochę o masażu relaksacyjnym karku, dłoni i stóp i zrobicie sobie masaż. Ćwiczenia i wykład interaktywny poprowadzi Stanisław Kalicki Coach związków i relacji. Uczy technik tworzenia szczęśliwego życia w związku. Prowadzi warsztaty \"Moc Pary dla Pary\". Kanclerz Fundacji Już Pomagam, vice prezesem Fundacji Zdrowia ESCO, współzałożycielem Stowarzyszenia na rzecz pomocy dzieciom z chorobami nowotworowymi Pomóż dziecku wyzdrowieć, Stowarzyszenia Krewaktywni.",
  ...
  {
    "event": "UNIA RÓWNOŚCI - MIĘDZY MARZENIAMI A RZECZYWISTOŚCIĄ\nStowarzyszenie Kongres Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "12.00-13.00 UNIA RÓWNOŚCI - MIĘDZY MARZENIAMI A RZECZYWISTOŚCIĄ czyli jak w Unii\nEuropejskiej robić równość - gdzie byliśmy i dokąd zmierzamy. Opieka; Bogna Czałczyńska",
  ...
  {
    "event": "Co wolno z żubrem w lesie?\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat połączony z krótkimi zajęciami \"survival\" i wyjaśnieniem przepisów oraz zasad działania programu \"Zanocuj w Lesie\".",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Dyskusje, pytania oraz spotkania z gośćmi More Life Future\nMore Life Future",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Debata „17,6% mniej, czyli o równości płac w rzeczywistości”\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Debata „17,6% mniej, czyli o równości płac w rzeczywistości”  – Mimo prawnych gwarancji równego traktowania, również w odniesieniu do wynagradzania, dane wskazują, że kobiety nadal zarabiają kilkanaście procent mniej niż mężczyźni. W debacie poruszymy temat luki płacowej, zastanawiając się nad jej przyczynami i skutkami oraz możliwościami rozwiązania tego problemu. \nModeracja: Aleksandra Szczerba",
  ...
  {
    "event": "DIALOG O PRAWACH CZŁOWIEKA W GAZIE\nStowarzyszenie Amnesty International",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W namiocie Amnesty zapraszamy do dialogu o prawach człowieka w konfliktach zbrojnych. W kręgach porozmawiamy o katastrofie humanitarnej w Gazie, o potrzebie międzynarodowej solidarności, i o szansach na rozejm.",
  ...
  {
    "event": "STREFA PLANETA WIEDZY -  spotkania z mentorami, mówcami i specjalistami - sprawdź sam z kim spotkasz się na miejscu!\nMore Life Future",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Namiot Warsztatowy ASP",
    "kind": "Warsztat",
    "description": "Lubisz śpiewać? A może grasz na jakimś instrumencie? Jeżeli tak to koniecznie musisz wziąć udział w warsztatach muzycznych z Piotrem Bukartykiem. Tradycyjnie już jak co roku, Piotr Bukartyk wraz z uczestnikami festiwalu przygotuje wspaniałe widowisko na zakończenie tegorocznej edycji Pol’and’Rock Festiwal. To dla Ciebie niesamowita szansa, aby wystąpić na Dużej Scenie na Najpiękniejszym Festiwalu Świata.\n  \n \n  #ASP",
  ...
  {
    "event": "Naucz się w protesty + \"Jeden/jedna z dziesięciu\"\nOgólnopolski Strajk Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Naucz się w protesty + \"Jeden/jedna z dziesięciu\" Konkurs wiedzy o historii Ogólnopolskiego Strajku Kobiet oraz o prawach obywatelskich",
  ...
  },
  {
    ...
    "place": "Duży Namiot ASP",
    "kind": "Spotkanie",
    "description": "Jan Jurkowski i Marek Hucz to absolwenci Państwowej Wyższej Szkoły Teatralnej w Krakowie. Swoją współpracę rozpoczęli jeszcze w trakcie studiów, gdzie w ramach rozrywki wspólnie wymyślali różne scenariusze dla formatów filmowych. Ich wspólna pasja i kreatywność zaowocowały powstaniem kanału Grupy Filmowej Darwin w serwisie YouTube. Przełomowym momentem w działalności G.F. Darwin okazała się seria „Wielkie Konflikty”. Są również autorami kultowych \"Orek z Majorki\".  \n \n  #ASP",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty z tworzenia rakiet wodnych\nRakieciara",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA DZIECIĘCA GWIAZDA - Gwiezdne wzory - bransoletki z koralików\nMBP Borne Sulinowo",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "What does the fox say? - prezentacja: 7 niesamowitych faktów o lisach",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Retencja leśna jako narzędzie przeciwdziałania zmianom klimatu. Warsztat interaktywny z wykorzystaniem okularów VR.",
  ...
  {
    "event": "Debata \"Humanitarny ubój - czy możliwe jest jedzenie mięsa z czystym sumieniem?\"\nAnonymous for the Voiceless",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na debatę na temat popularnego mitu - możliwości humanitarnego zabijania zwierząt.",
  ...
  {
    "event": "STREFA DZIECIĘCA GWIAZDA -  Kosmiczna odyseja z pedagogiką zabawy\nPolitechnika Koszalińska",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Debata \"Mleko od szczęśliwych krów - prawda czy fikcja?\"\nAnonymous for the Voiceless",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na debatę na temat popularnego mitu - możliwe jest pozyskiwanie mleka od krów bez wyrządzania zwierzętom krzywdy.",
  ...
  {
    "event": "Pokazowe posiedzenie aresztowe \"SIĄDŹ&OSADŹ!\"\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Wzięcie udziału w pokazowym posiedzeniu aresztowym pozwoli zrozumieć uczestnikom na czym polega prawo do sądu , kogo , jak i kiedy można aresztować bez prawomocnego wyroku, przeprowadzimy też dyskusję jak Wy jako obywtele możecie wspomóc sędziów w wydaniu  sprawiedliwych wyroków.. Pokazowe posiedzenie aresztowe na podstawie prawdziwej historii, gdzie decyzję o zastosowaniu tymczasowego aresztowania podejmą publika, sędzia i sztuczna inteligencja. Na zakończenie dyskusja o tym co zrobić , żeby sądzenie było łatwiejsze i bardziej zrozumiale dla stron i obywateli.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "KOBIETY A POLITYKA. Męska gra i męskie zasady Dlaczego kobiet u władzy jest mniej niż w społeczeństwie? Kto właściwie jest dyskryminowany? Skąd nadreprezentacja mężczyzn we władzach wszelakich i czy to dobrze? dlaczego warto brać udział w wyborach i dlaczego wciąż w polityce jest \ntak mało kobiet. Dyskusję będzie prowadzić posłanka na sejm Jolanta Niezgodzka, odpowie na wszystkie pytania i zachęci do aktywności politycznej, pokaże że kobiety mają głos i mają moc.",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty lawendowe - zaplatanie lawendy\nBarbara Opar",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Instalacja yarnbombingowa: Słoneczniki\nUniwersyetet Artystyczny im. Magdaleny Abakanowicz w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Instalacja yarnbombingowa Słoneczniki została zaprojektowana i przygotowana w ramach spotkań rękodzielniczych zorganizowanych przez poznański kolektyw Pikotki Crew. W czasie ich trwania różne osoby rękodzielnicze wykonały ręcznie elementy na szydełku, które w swojej formie nawiązują do pola słoneczników, czyli charakterystycznej części Polandrock. Część z nich została przygotowana w ten sposób, aby zaangażować do ich wykończenia i montażu uczestników festiwalu – stworzy to możliwość uruchomienia pokładów kreatywności i nawiązania rozmowy o yarnbombingu i rękodziele.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat będzie stwarzał okazję poznania skutecznych technik samodzielnej nauki i zarządzania zasobami osobistymi w celu realizacji zamierzonych celów. Dedykowany jest szczególnie młodzieży oraz chętnym dorosłym. Warsztat poprowadzi doświadczona osoba trenerska.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dołącz do nas, aby poczuć siłę i wyrazistość sztuki niepełnosprawnych artystów, którzy malują na co dzień ustami czy stopami. Wspólnie stworzymy wielkoformatowy mural festiwalowy, który będzie pełen kolorów i emocji. Nie przegap tej wyjątkowej okazji, aby doświadczyć prawdziwej mocy sztuki!",
  ...
  },
  {
    ...
    "place": "Duża Scena",
    "kind": "Koncert",
    "description": "Less Than Jake to jedna z najbardziej energetycznych kapel ska-punkowych na świecie! Ich historia jest nie do opisania jedynie poprzez liczbę tras koncertowych czy albumów na koncie. To, co naprawdę wyróżnia tę legendarną ekipę, to niepowtarzalna energia, którą przywożą ze sobą na wszystkie występy. Od małych klubów po ogromne festiwale, od miasteczek w USA po największe sceny świata, ich muzyka zawsze dotyka serc i rozgrzewa dusze.\n  \n \n  #ska",
  ...
  {
    "event": "Rozmowy o zachodzie słońca: „lepiej zapobiegać niż leczyć \"\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "doświadczeni sędziowie karniści na bazie historii z życia wziętych po wylosowaniu tematyki przez publikę poruszą temat odpowiedzialności karnej, jak jej unikać, jak zapobiegać  przestępczości , o odpowiedzlanosci karnej z nierozwagi wziętej w świecie wirtualnym i realnym",
  ...
  {
    "event": "Debata „Zanieczyszczenie światłem”  cz. II\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Debata „Zanieczyszczenie światłem” – LP (ang. light pollution) jest coraz większym problemem, skutkuje negatywnie dla zdrowia człowieka (zaburzenie rytmu dobowego, bezsenność, obniżenie odporności, depresja, zwiększenie ryzyka nowotworów, dłuższe sezony na alergie na skutek zmian pór kwitnienia roślin) i degradująco na przyrodę (zaburzony biorytm zwierząt i roślin, wymieranie gatunków fotowrażliwych). LP to także powolna śmierć astronomii i niweczenie dorobku M. Kopernika – przez smog świetlny obserwacja ciał niebieskich jest mocno utrudniona, obserwatoria astronomiczne, w tym np. podwarszawski Ostrowik mogą niedługo stracić rację bytu. \nW Polsce brakuje regulacji prawnych dotyczących emisji światła. Niezwykle istotne jest więc szerzenie w społeczeństwie wiedzy na temat zanieczyszczenia świetlnego i sposobów ograniczania szkodliwości sztucznego światła, które mamy w swoim zasięgu.\nForma wydarzenia: krótkie prezentacje ekspertów (obrazki, rekwizyty), dyskusja z uczestnikami. Prezentacja „pakietów edukacyjnych” (eksperyment świetlny, oprawa lamp przeciwdziałających LP, domowe urządzenie do badania wpływu światła na rośliny etc.)\nModeracja: Małgorzata Żera, Małgorzata Żmudka-Wyrwał\ncz. II",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W trakcie warsztatu zostaną omówione sytuacje w których mogą znaleźć się współwłaściciele nieruchomości oraz to w jaki sposób mogą się zachować; Prowadzący przedstawią prawa i obowiązki współwłaścicieli na przykładzie tzw. małej wspólnoty mieszkaniowej. Warsztat obejmie również sesję Q&A w zakresie praw i obowiązków współwłaścicieli nieruchomości.",
  ...
  {
    "event": "Hipnotyczne warsztaty z przymrużeniem oka\nPolska Akadmeia Rozwoju Osobistego",
    "place": "Namiot Warsztatowy ASP",
    "kind": "Warsztat",
    "description": "Warsztaty z hipnozy w luźnym i rozrywkowym wydaniu. Przez ostatnie 7 lat mieliśmy przyjemność tworzyć w ASP show hipnozy, które zawsze ściągało tłumy. Tym razem chcemy bardziej skoncentrować się na przekazaniu wiedzy i umiejętności. W tym celu zamierzamy zaprosić uczestników do wspólnej zabawy, ucząc ich korzystania z pewnych elementów hipnozy w swoim życiu oraz wywoływania hipnotycznych fenomenów. Wszystko to w radosnym, komediowym i edukacyjnym wydaniu.",
  ...
  },
  {
    ...
    "place": "Mała Scena",
    "kind": "Koncert",
    "description": "Krzysztof Sokołowski to postać legendarnej już rangi w polskim świecie muzycznym. Od lat zdobywa serca fanów zarówno jako frontman Nocnego Kochanka jak i naczelny głos Exlibris (w latach 2012-2015) oraz Polish Metal Alliance. Po 4 występach Nocnego Kochanka na Najpiękniejszym Festiwalu Świata (pierwszy występ Nocnego Kochanka na Dużej Scenie 23. Przystanku Woodstock był wynikiem wyłonienia zespołu w konkursie Eliminacji) Krzysztof Sokołowski powraca, tym razem w ramach działalności solowej pod szyldem „Sokołowski”.  \n \n  #rock",
  ...
  },
  {
    ...
    "place": "Duża Scena",
    "kind": "Koncert",
    "description": "Electric Callboy to więcej niż zespół – to muzyczna rewolucja. Ich występ na Pol’and’Rock Festival 2024 to nie tylko szansa na doświadczenie ich niesamowitej energii na żywo, ale także okazja, by stać się częścią ich rosnącej, globalnej społeczności fanów. Zapraszamy wszystkich na tę wyjątkową muzyczną podróż, gdzie Electric Callboy zaprezentuje swoje największe hity oraz nowe, ekscytujące brzmienia. Do zobaczenia pod Dużą Sceną!  \n \n  #metal",
  ...
  },
  {
    ...
    "place": "Duża Scena",
    "kind": "Koncert",
    "description": "Modestep to projekt muzyczny, który z łatwością przenosi słuchaczy przez różnorodne gatunki muzyczne. Debiutancki album \"Evolution Theory\" nie tylko podbił listy przebojów, ale także zdefiniował ich charakterystyczny styl. Z unikalnym połączeniem dubstepu, drum & bass oraz hard rocka wraca po dziewięciu latach na Dużą Scenę Najpiękniejszego Festiwalu Świata!  \n \n  #muzyka elektroniczna",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Na spotkaniu poruszony będzie temat szeroko rozumianego szczęścia - jak i gdzie go wgl szukać? Przyjrzymy się kluczowym aspektom, na które warto zwrócić uwagę, abyśmy mieli poczucie, że nasze życie ma sens i było satysfakcjonujące. Co robić, aby nie utknąć w miejscu i czerpać radość z życia?\nPaweł Myjkowski Trener mentalny, coach Pomaga uwierzyć w siebie i ruszyć z miejsca. Dodaje wiatru w żagle i zachęca do sięgania po więcej. Prowadzi obozy szkoleniowe, na których uczestnicy mogą wejść w głąb siebie i odnaleźć wewnętrzny spokój, ukryte motywacje i to, co jest dla nich naprawdę ważne.",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Badanie składu ciała wraz  indywidualnym omówieniem wyniku z dietetykiem\nPZH",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Szlagierowy konkurs Namiotu Radców Prawnych w wydaniu z notariuszami: zakręć kołem, odpowiedz na pytanie prawne i wygraj nagrodę niespodziankę.\nOczywiście, można nie mieć szczęścia i zamiast nagrody wygrać karę - niespodziankę ;) . Zapraszamy wszystkich śmiałków!",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Choroby psychiczne, myśli samobójcze, uzależnienia, przemoc\nSPZZOZ w Gryficach",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA OBSERWATORIUM -  Mechanizmy obronne w relacji, akceptacja, inne formy aktywności seksualnej\nSPZZOZ w Gryficach",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Drewniane drogowskazy\nMBP Borne Sulinowo",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W tym roku Namiot Radców Prawnych gości notariuszy z Izby Notarialnej w Poznaniu, którzy przeprowadzą wyjątkowe, prawniczo - plastyczne zajęcia dla najmłodszych uczestników festiwalu",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Psycholog, psychiatra….kiedy zapukać do których drzwi\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "kuj żelazo póki gorące\nstowarzyszenie stara oliwa im.Danuty Rolke-Poczman",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "kujemy w prawdziwym palenisku kowalskim , chcemy za poznać młodzież z arkanami pracy kowala, ktora praktycnie nie zmienila sie od tysiąc lat",
  ...
  },
  {
    ...
    "place": "Duży Namiot ASP",
    "kind": "Spotkanie",
    "description": "Magda Mołek – ikona polskiego dziennikarstwa i inspirująca mówczyni motywacyjna. Spotkanie z gościem specjalnym mBanku będzie wyjątkową okazją do szczerej rozmowy o autentyczności, dążeniu do doskonałości i czerpaniu radości z życia.  \n \n  #ASP",
  ...
  {
    "event": "„Twoje prawa, nasza sprawa” – prawa osobiste\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "„Twoje prawa, nasza sprawa” – prawa osobiste –  Zajęcia prowadzone na bazie wydanej przez BRPO publikacji i na podstawie spraw, jakie są zgłaszane do Rzecznika Praw Obywatelskich. Warsztat wiedzy obywatelskiej i wszelkich działań na rzecz praw człowieka",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Poczuj moc kreatywności, tworząc niepowtarzalne, zabawne i unikalne opaski do włosów! Każdy otrzyma opaskę i różne ozdoby, aby stworzyć jedyną w swoim rodzaju ozdobę na głowę, która będzie wyróżniać się na tle festiwalowej zabawy",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Rak w rodzinie - jak rozmawiać? Jak wesprzeć bliską osobę która choruje?\nZCO",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dyskusja dotycząca spojrzenia z dwóch stron: gdy osoba aneurotypowa doświadcza przemocy oraz ją stosuje. Jak wiele osób z ASD pada ofiarą przemocy i dlaczego? Na który jej rodzaj są najbardziej narażeni? Czy ASD uzasadnia zachowanie agresywne? Analizujmy przyczyny i sposoby przeciwdziałania.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Konsultacje skierowane do obu stron postępowania. Postaramy się wyjaśnić wszystkie zawiłości z jakimi możecie się spotkać próbując odzyskać lub zapłacić alimenty.",
  ...
  {
    "event": "STREFA DZIECIĘCA GWIAZDA - Malowanie na plastrze drewna\nMBP Borne Sulinowo",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Dlaczego psychiatra zaleca jogę? - tu ciało spotyka umysł\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty tworzenia toreb z siatki mesh\nReMakeIt",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Energetyka wiatrowa elementem transformacji energetycznej\nPSEW",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W warsztacie: zadania Służby Więziennej, obowiązki osadzonych, podkultura więzienna (grypsowanie, zwyczaje, niepisane zasady, znaczenie tatuaży), widzenia, zagrożenia w codziennej służbie, napaści na funkcjonariuszy, uprawnienia funkcjonariuszy, wskazanie na co najczęściej skarżą się osadzeni.",
  ...
  {
    "event": "Panel dyskusyjny - Oswajamy niepełnosprawność\nFundacja Złotowianka",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Niekiedy  spotykając ludzi z niepełnosprawnościami nie potrafimy zachować się swobodnie. Zazwyczaj wynika  to z braku wiedzy co powinniśmy zrobić. Co powiedzieć, czy pomagać, w jaki sposób proponować wsparcie?  Zapraszamy na panel dyskusyjny z udziałem osób z niepełnosprawnościami, które podzielą się swoimi doświadczeniami i wyzwaniami codziennego życia. Chcemy razem z Wami poruszyć temat akceptacji i integracji osób z niepełnosprawnościami w społeczeństwie, odpowiedzieć na Wasze pytania, rozwiać wątpliwości oraz poszukać sposobów na rozwijanie świadomości na ten temat.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Pamiętasz taką panią jak Doda? My tak, i bardzo chcemy zadać jej parę pytań - jak żyje, kiedy następna płyta i takie tam. Chcesz zadać jej pytania, dodać jej otuchy lub powiedzieć \"nie daj się\"? Przyjdź do nas!",
  ...
  {
    "event": "Debata „Wolność zgromadzeń a zatrzymania przez funkcjonariuszy Policji”\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Debata „Wolność zgromadzeń a zatrzymania przez funkcjonariuszy Policji” – debata o prawie do wolności zgromadzeń, jakie prawa rządzą organizowaniem protestów społecznych, rola policji w zabezpieczeniu bezpieczeństwa, prawa osób uczestniczących w protestach oraz prawa osób zatrzymanych podczas protestów.\nModeracja:  Adam Krzywoń",
  ...
  {
    "event": "Wszystko na temat środków antykoncepcyjnych -wkładka, implant\nOgólnopolski Strajk Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Przedstawienie gwarantowanych możliwości świadczeń, które wielokrotnie są nieprzestrzegane a gwarantowane dla pacjentki założenia i wyjęcia wkładki na NFZ. Wyjaśnienie co należy zrobić i jakie mamy prawa  w przypadku odmowy świadczenia:\nDzięki warsztatom uczestnicy będą mieli lepsze zrozumienie praw pacjenta, procedur i możliwości  skorzystania z dostępnych świadczeń medycznych na NFZ dotyczących wkładek.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy do namiotu Amnesty na quiz z nagrodami - z wiedzy o osobach LGBTI i prawach człowieka.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztaty dotyczące gospodarowania odpadami. Jak jest? Jak powinno być? Gdzie jest przestrzeń do poprawy  lub zmian? Nie wiesz co zrobić z niektórymi odpadami? Przyjdź i porozmawiaj z nami.",
  ...
  {
    "event": "quiz z praw ucznia z nagrodami\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "czy uczniowie mają tylko prawa, czy też obowiązki, przyjdź wylosuj pytanie, zastanów się nad prawidłową odpowiedzią , wylosuj atrakcyjną nagrodę ukryta w naszej loterii ;)",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Witamina N - o tym jak natura wspomaga zdrowie psychiczne\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Otwarta sesja rysunkowa\nUniwersyetet Artystyczny im. Magdaleny Abakanowicz w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztaty z rysowania są otwartą sesją rysunkową podczas, której każda z osób może dołączyć w dowolnym momencie jej trwania. Można rysować samodzielnie, grupowo, dorysowywać części do już powstałych rysunków.\nW zaproponowanym działaniu osoby uczestniczące będą skupiać się przede wszystkim na procesie, prostocie i czerpaniu radości z rysowania.",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Energetyka wiatrowa - fakty i mity. Kobiety w sektorze energetycznym\nPSEW",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Duży Namiot ASP",
    "kind": "Spotkanie",
    "description": "Zygmunt Miłoszewski, jeden z najpopularniejszych polskich pisarzy w kraju i za granicą. To powieściopisarz, scenarzysta i działacz społeczny, znany m.in. z trylogii kryminalnej o prokuratorze Teodorze Szackim. Autor wielokrotnie nagradzany, m.in. Paszportem \"Polityki\" w 2015 roku oraz Nagrodą Wielkiego Kalibru za całokształt twórczości w 2020 roku, i tłumaczony na kilkanaście języków. Jest także współautorem scenariusza do serialu \"Prokurator\", który w 2016 roku zdobył nagrodę Orła w kategorii Najlepszy Filmowy Serial Fabularny.  \n \n  #ASP",
  ...
  {
    "event": "Czy można wydłużyć Pol’and’Rock? - czyli o dylatacji czasu, paradoksie bliźniąt i skąd to się wszystko wzięło\nPolitechnika Gdańska",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Wykład przeprowadzony przez dwie absolwentki Politechniki Gdańskiej - fizyczkę oraz nanotechnolożkę, które postarają się Wam przybliżyć wiedzę fizyczną w prosty, obrazowy sposób z elementami performance’u i żartu. Tematyką wykładu będą podstawy teorii względności, czasoprzestrzeń, dylatacja czasu, paradoks bliźniąt. Jeśli oglądałeś film Interstellar - ten wykład jest dla Ciebie. Jeśli nie - pewnie obejrzysz go jak tylko wrócisz z festiwalu.",
  ...
  {
    "event": "Pokazy technik interwencyjnych Grupy Interwencyjnej Służby Więziennej\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Pokaz obezwładniania osób niebezpiecznych, konwojowania osadzonego niebezpiecznego, praktycznego używania środków przymusu bezpośredniego .",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "\"Podczas warsztatów będzie można nauczyć się jak ze zwykłych kartek papieru zrobić proste ruchome zabawki, które pod zręcznymi palcami ożywają. Pod czujnym okiem instruktora własnoręcznie złożycie modele, które wywołają uśmiech na twarzy. Zapewniamy papier i świetną zabawę!\nZapraszamy zarówno dzieci jak i dorosłych.\"",
  ...
  {
    "event": "Debata \"Jajka od szczęśliwych kur - prawda czy fikcja?\"\nAnonymous for the Voiceless",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na debatę na temat popularnego mitu - możliwe jest pozyskiwanie jajek bez krzywdzenia kur.",
  ...
  {
    "event": "STREFA DZIECIĘCA GWIAZDA -  Kosmiczna odyseja - sensoplastyczna podróż po Planetach\nPolitechnika Koszalińska",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Prezentacja sprzętu i wyposażenia Służby Więziennej\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Możliwość wypróbowania sprzętu, w tym: kajdanki, gejsza oraz możliwość założenia wyposażenia ochronnego Służby Więziennej",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty tworzenia toreb z t-shirtów\nReMakeIt",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Test 5 języków miłości i panel dyskusyjny o komunikacji w relacji",
  ...
  {
    "event": "Debata \"Zoo - ochrona przyrody czy więzienie?\"\nAnonymous for the Voiceless",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy na debatę na temat popularnego mitu - ogrody zoologiczne służą przyrodzie i edukują.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "What does the fox say? Quiz  - drużynowy turniej wiedzy o lisach. Na zwycięzców czekają nagrody!",
  ...
  {
    "event": "Rozmowy o zachodzie słońca: cyberprzemoc na co to komu?!\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "spotkanie o zachodzie słońca w trakcie którego sprobujemy w gronie fachowców porozmawiać o tym :  kto, dlaczego i jak krzywdzi w Internecie , jak sobie radzić z tą formą przemocy, co zrobić , żeby nie być ofiarą? ale jak się zachowywać w siedzi , żeby nie być sprawcą?",
  ...
  {
    "event": "Jak rozpoznać czy to już dyskryminacja, czy to już mobbing?\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Case study. Radcowie na przykładach wytłumaczą jak rozpoznać, czy dana sytuacja służbowa nosi cechy dyskryminacji lub mobbingu.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat o podstawowych technikach zwiększenia rozumienia drugiej osoby co jest fundamentem stworzenia zdrowego, zjednoczonego społeczeństwa poprowadzi Paweł Żurek",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Kolejna odsłona tematu poruszanego w Namiocie Radców Prawnych w 2022 r. oraz 2023 r. Radcowie odpowiedzą na pytania: - co w praktyce oznacza pakt migracyjny? - polska polityka migracyjna - w jakim kierunku idziemy? - nowe rozwiązania dla obywateli Ukrainy? - czy polskie prawo migracyjne podąża za zmieniającą się rzeczywistością? Notariusze przedstawią praktyczny aspekt kontaktu imigrantów z notariuszami.",
  ...
  {
    "event": "Ochrona prawna utworów sztucznej inteligencji\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Podczas warsztatu uczestnicy omówią wyzwania związane z prawami autorskimi do dzieł generowanych przez AI oraz potrzebę zaistnienia zrównoważonych rozwiązań prawnych, które ochronią interesy twórców i użytkowników tej technologii.",
  ...
  },
  {
    ...
    "place": "Mała Scena",
    "kind": "Koncert",
    "description": "PTAKY – polski zespół rockowy, założony w Gdańsku w 2003 roku, przez Piotra Łukaszewskiego, gitarzystę grającego wcześniej m.in. w zespołach: TSA-Evolution, Skawalker, IRA oraz KarmaComa. Pierwsze dwa krążki „PTAKY” (2004 r.) i „Szkoła Latania (2008 r.) na stałe wpisały się do kanonu polskiej muzyki rockowej.  Utwór „Chroń to co masz” był oficjalnym singlem promującym w Polsce film „Spider Man2”     \n \n  #rock",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "gra,  w której uczestnicy wylosują profesję lub postać związaną z wymiarem sprawiedliwości  i na podstawie pytań zadawanych innym  będą musili odpowiedzieć kim są , jaki zawód  lub jaką postać  reprezentują, \ndo wylosowania będą takie profesje jak sędzia, adwokat, prokurator, radca prawny, notariusz, kurator, asystent sędziego, referendarz sądowy, komornik...",
  ...
  {
    "event": "STREFA DZIECIĘCA GWIAZDA - Nie-ziemskie doświadczenia i eksperymenty z żywiołami\nPolitechnika Koszalińska",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Napisz pocztówkę do polityków w sprawie zakazu hodowli zwierząt na futra\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Napisz pocztówkę do polityków w sprawie zakazu hodowli zwierząt na futra",
  ...
  {
    "event": "STREFA PLANETA ZDROWIA - Spotkanie z kardiologiem- określenie stopnia ryzyka sercowo-naczyniowego, omówienie wyników, zalecenia dla pacjenta\nNarodowy Instytut Kardiologii",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "Dostępność dla osób z niepełnosprawnościami\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Dostępność dla osób z niepełnosprawnościami – Warsztat dotyczący dostępności w przestrzeni fizycznej. Celem warsztatów jest uzmysłowienie uczestnikom, jak dostępność przestrzeni publicznej jest istotna z perspektywy osób z niepełnosprawnością",
  ...
  {
    "event": "Festiwalowy Pałac Ślubów -  śluby wyznaczonych wcześniej 10 par\nUSC Czaplinek",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  {
    "event": "Jak depresja wpływa na życie seksualne\"\nOgólnopolski Strajk Kobiet",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Spotkanie z terapeutką poprzez otwartą dyskusję i fachowe wskazówki zagłębimy temat i zapoznamy się jak należy zrozumieć wpływ depresji na sferę Intymną. Warsztaty mają na celu stworzenie bezpiecznej przestrzeni do wymiany doświadczeń oraz zdobycie praktycznych narzędzi wspierających zdrowe funkcjonowanie seksualne pomimo depresji.",
  ...
  {
    "event": "„Twoje prawa, nasza sprawa” – prawa obywatela\nBiuro Rzecznika Praw Obywatelskich",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "„Twoje prawa, nasza sprawa” – prawa obywatela. Zajęcia prowadzone na bazie wydanej przez BRPO publikacji i na podstawie spraw, jakie są zgłaszane do Rzecznika Praw Obywatelskich. Warsztat na temat promowania wiedzy obywatelskiej i wszelkich działań na rzecz praw człowieka",
  ...
  {
    "event": "Dla dzieci co to jest - zabawa w ukryty przedmiot\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "zabawa dla dzieci w ukryty przedmiot związany z wymiarem sprawiedliwości ,  dzieci najpierw  odgadną jaki to jest przedmiot , a potem sprobujemy wspólnie wyjaśnić do czego służy , w ten sposób przybliżymy dzieciom zasady funkcjonowania wymiaru sprawiedliwości",
  ...
  {
    "event": "Dziecka prawa - moja sprawa\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Co to jest prawo? Do czego dziecko ma prawo? Do czego rodzic nie ma prawa?  Odpowiedzi na te i inne pytania związane z prawami dziecka.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Why does the fox suffer? - za pomocą gogli VR zobacz jak wygląda życie na fermie futerkowej",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Chcesz poczuć moc swojej kreatywności? Dołącz do naszych warsztatów, gdzie stworzysz unikalne ozdoby, które będą wyrażać Twoją osobowość i styl! Każdy uczestnik otrzyma zestaw do tworzenia zabawnych, ciekawych, i ekstrawaganckich bransoletek, kolczyków oraz innych ozdób. Poczuj się jak artysta i pozwól swojej wyobraźni szaleć!",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat poświęcony uprzedzeniom i ćwiczeniu otwartości połączony z działaniem performatywnym, gdzie osoby uczestniczące wypełniają używane wcześniej słoiki lub butelki z etykietami nową \"treścią\", np. słoik po dżemie zostaje wypełniony ziarnami fasoli, a butelka po soku pomarańczowym - solą. Każda osoba ma wkład w wystawę, którą tworzą wszystkie naczynia. Tak stworzone przedmioty wykorzystamy też jako środek własnego wyrazu w komunikowaniu swojej postawy otwartości i braku zgody na osądzanie czy przemoc.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Konkurs wiedzy o komorniku i egzekucji. Czekają na Was ciekawe nagrody.",
  ...
  {
    "event": "KONWENCJA STAMBULSKA i JEJ ZNACZENIE DLA KOBIET W POLSCE\nStowarzyszenie Amnesty International",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zapraszamy do namiotu Amnesty na krótką PRELEKCJĘ o Konwencji Stambulskiej i jej znaczeniu dla kobiet i dzieci w Polsce, po której zapraszamy do DIALOGU O (S)PRAWACH KOBIET. W kręgach podzielimy się naszymi przekonaniami i spróbujemy usłyszeć osoby o odmiennych poglądach.",
  ...
  {
    "event": "Młotkowanie roślin na torbach eko z motywem słowiańskim\nWioska Słowiańska",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Słowianie zawsze byli blisko natury i roślin. Na warsztatach, będzie można zagłębić się w technikę młotkowania, czyli dekorowania materiału za pomocą młotka i żywych roślin. Każdy uczestnik będzie mógł wykonać własną eko torbę z motywami roślinnymi i słowiańskimi.",
  ...
  {
    "event": "Sekcja zwłok: co, jak, w jakiej kolejności  i dlaczego?  - zajęcia z Prokuratorem Krajowym\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W warsztacie - wszystko co chcielibyście wiedzieć o sekcji zwłok, a o co boicie się zapytać? Pokaz z użyciem manekina. Q&A.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W Polsce ok. 1 miliona dzieci nie dostaje alimentów od swojego rodzica. Spotkanie z autorką zmian legislacyjnych - mec. Danutą Wawrowską.",
  ...
  {
    "event": "Prawo kanoniczne - śluby, rozwody, apostazja.\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "W programie warsztatu: jak przeprowadzić procedurę apostazji, jak się rozwieść i wiele innych.",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "autorska zabawa,  w której uczestnikom zostaną rozdane tablice z cytatami znajdujące się na budynku Sądu Najwyższego , każdy z cytatów będzie podzielny na dwie części zadaniem uczestników będzie dobranie się w prawidłowe pary",
  ...
  {
    "event": "Zatańczmy Pol'and'Rockowego Poloneza! (start: pasaż przy Strefie Pomorza Zachodniego)",
    "place": "Pomorze Zachodnie",
    "kind": "Inne",
    "description": "",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Ideą projektu „Sport powszechny przyjazny dla środowiska” (Environmentally sustainable Sport for All – EnvInSport) jest podnoszenie świadomości na temat korzyści płynących z zagadnień zrównoważonego rozwoju w sporcie dla wszystkich. Jej celem jest podejście zrównoważone środowiskowo w działaniach sportowych.",
  ...
  },
  {
    ...
    "place": "Duży Namiot ASP",
    "kind": "Spotkanie",
    "description": "Remigiusz Mróz — doktor nauk prawnych, aktywista społeczny i najpopularniejszy polski powieściopisarz ostatnich lat. Jego imię stało się synonimem literackiego mistrzostwa, a jego książki zdobyły serca milionów czytelników nie tylko w Polsce, ale na całym świecie. Remigiusz Mróz jest autorem niezwykle różnorodnych dzieł, od trzymających w napięciu kryminałów po mądrą publicystykę, odważnie podnoszącą społeczne tematy. Teraz będziemy mieli niepowtarzalną szansę poznać go bliżej, zanurzając się w jego fascynującym światku literackich tajemnic.  \n \n  #ASP",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Zaplatanie gwiezdnych łapaczy snów\nCZOK",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "BEZPRZEMOCOWA AKCJA BEZPOŚREDNIA w OBRONIE PRAWA DO ABORCJI\nStowarzyszenie Amnesty International",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "Gdy pęknie rura w mieszkaniu\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Rzecz o tym jak skutecznie egzekwować swoje prawa lokatorskie, właścicielskie. Jak postępować w kontaktach z ubezpieczycielem.",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Gdy silna wola jest za słaba. Dlaczego ciężko walczyć z uzależnieniami\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Kto choruje na raka jelita grubego? Dieta, ruch i geny - na co mam wpływ\nZCO",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Dla kogo \"trudne zachowania\" są trudne? O emocjach i samoregulacji osób w spektrum autyzmu.\nPrzylądek Dobrej Nadziei",
    "place": "Namiot Warsztatowy ASP",
    "kind": "Warsztat",
    "description": "Sztywność i intensywne emocje... – dlaczego dzieci krzyczą, płaczą i uderzają siebie lub innych? – jak działać podczas takich momentów? – istota i rola działań regulacyjnych Nie będzie o tym, jak ,,wygaszać’’… Nie będzie o tym, jak ,,zastępować’’… Nie będzie o tym, jak ,, przekierowywać uwagę’’… Będzie o tym jak wspierać. Będzie o tym, jak zadbać o bezpieczeństwo. Będzie trochę o granicach. Będzie o tym co możemy zmienić w sobie. Będzie dużo o emocjach i samoregulacji. Będzie to godzinny warsztat z prostymi ćwiczeniami w grupie oraz szeregiem eksperymentów myślowych, które posłużą nam do szukania rozwiązań i sposobów wspierania osób w spektrum w trudnych dla nich momentach.",
  ...
  {
    "event": "Pierwsza pomoc prawna dla początkujących twórców - jak się zabezpieczyć rozpoczynając działalność artystyczną ?\nOkręgowa Izba Radców Prawnych w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat o tym, co każdy młody twórca wiedzieć powinien. Jak zabezpieczyć siebie oraz swoją twórczość. Podpowiedzi, wymiana doświadczeń, Q&A.",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Zdrowie psychiczne naszych pociech w centrum uwagi\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA OBSERWATORIUM - Ile gwiazd w kosmosie, tyle różnych aromatów kawy!\nA. Małachowski Qualia Caffe",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Sportowa Olimpiada Sądowa\nStowarzyszenie Sędziów Polskich  \"Iustitia\"",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "zabawa wymagająca wiedzy i umiejętności w trakcie,  której będzie można się sprawdzić w typowych czynnościach sądowych , dla trzech najlepszych osób przewidziano nagrody, dla zwycięzcy puchar i uścisk \"ręki prezesa\" ;) . \nWśród konkurencji taki zdania jak nieomylne  czytanie  wyroków  czy szycie akt,.....zapraszamy do wspólnej zabawy. \nCałość zostanie zakończona wręczeniem nagród i wspólnym pamiątkowym zdjęciem!",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty lawendowe - mydełka\nBarbara Opar",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Z Tobą na chacie\nOkręgowa Izba Radców Prawnych w Poznaniu i Izba Notarialna w Poznaniu",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Warsztat o tym: jak bezpiecznie wynająć pierwsze mieszkanie? Do czego lokator ma prawo? Jakie obowiązki spoczywają ma właścicielu mieszkania ?  Kto odpowiada za powstałe długi w trakcie wynajmu, co to jest najem okazjonalny, co to jest najem instytucjonalny ?",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Jakie zagrożenia niesie ze sobą cyberprzemoc? Naucz się rozpoznawać różne rodzaje cyberprzemocy i zdobądź wiedzę o tym, jak się przed nią chronić (podstawy cyberbezpieczeństwa).",
  ...
  {
    "event": "Kreatywna inkluzja – warsztaty malowania koszulek\nFundacja Avalon Bezpośrednia Pomoc Niepełnosprawnym",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  },
  {
    ...
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Zdjęcie Obecnych byłych członków Toastmasters oraz sympatyków na PolandRock Festiwal. Taka chwila dla Fotoreportera. W namiocie również dalsza część spotkania. Integracja, rozmowy i dyskusje o Toastmasters i wspomnienia starych czasów",
  ...
  {
    "event": "STREFA PLANETA WIEDZY - Jak będąc młodym dostrzegać problemy starszych\nSPSZOP Zdroje",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "STREFA KOSMICZNA PRACOWNIA - Warsztaty lawendowe - olejowe perfumy\nBarbara Opar",
    "place": "Pomorze Zachodnie",
    "kind": "Warsztat",
    "description": "",
  ...
  {
    "event": "Gra we flagówkę: Ekscytujący futbol amerykański w bezpiecznej formie!\nStowarzyszenie Kobiecej Drużyny Futbolu Amerykańskiego - Klub Sportowy Warsaw Sirens",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
  ...
  {
    "event": "Quiz z wiedzy o festiwalu Pol’and’Rock\nStowarzyszenie Otwarte Klatki",
    "place": "Strefa Warsztatów ASP",
    "kind": "Warsztat",
    "description": "Quiz z wiedzy o festiwalu Pol’and’Rock. Na zwycięzców czekają nagrody!",
  ...
  },
  {
    ...
    "place": "Duża Scena",
    "kind": "Koncert",
    "description": "Piotr Bukartyk (jak sam o sobie mówi) jest grajkiem. Od mniej więcej czterdziestu lat pisze do rymu, układa do tego melodie, a potem to śpiewa. Niezwykle utalentowany gitarzysta, kompozytor, piosenkarz i tekściarz ponownie zaszczyci nas swoją obecnością na Dużej Scenie, występując w towarzystwie warsztatowiczów, z którymi wspólnie uroczyście zakończą 30. edycję Pol'and'Rock Festival.   \n \n  #poezja śpiewana",
